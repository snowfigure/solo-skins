                ...
                <ul class="am-pagination">
                    <#if 1 < paginationCurrentPageNum>
                        <li class="am-pagination-prev">
                            <a class="prev" href="${servePath}/search?keyword=${keyword}&p=${paginationCurrentPageNum - 1}">&laquo; Prev</a>
                        </li>
                    </#if>
                    <#if paginationCurrentPageNum < paginationPageCount>
                        <li class="am-pagination-next">
                            <a class="next" href="${servePath}/search?keyword=${keyword}&p=${paginationCurrentPageNum + 1}">Next &raquo;</a>
                        </li>
                    </#if>
                </ul>
            </#if>
